        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Listings_Capacity_Positive", "[Capacity] > 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bookings_Date_Order", "[FromDate] < [ToDate]");
                    table.CheckConstraint("CK_Bookings_NoOfPeople_Positive", "[NoOfPeople] > 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ListingId_FromDate_ToDate",
                table: "Bookings",
                columns: new[] { "ListingId", "FromDate", "ToDate" });
